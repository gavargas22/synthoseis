...
Use the file-creator subagent to create the file: .agentic-docs/product/mission.md and use the following template:
...
Use the file-creator subagent to create the file: .agentic-docs/product/tech-stack.md and use the following template:
...
Use the file-creator subagent to create the file: .agentic-docs/product/mission-lite.md for the purpose of establishing a condensed mission for efficient AI context usage.
...
Use the file-creator subagent to create the following file: .agentic-docs/product/roadmap.md using the following template:

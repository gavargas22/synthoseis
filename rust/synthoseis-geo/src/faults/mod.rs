...
//!    Memory is O(fault surface), never O(cube).
...
pub use model::{
    middle_candidates, resolve_fault, survey_surface, throw_variance, vertical_profile,
    FaultGeometry, FaultSkip, ResolvedFault, Seabed,
};
pub use params::{
